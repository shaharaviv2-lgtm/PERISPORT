  ...
  return (
    <div className="flex flex-col w-full">
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="max-w-3xl space-y-6 md:space-y-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-secondary/50 border border-border backdrop-blur-sm">
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-primary">System Online // Version 2.4</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold uppercase leading-[0.9] tracking-tighter">
              Performance <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400">Engineered.</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground font-mono max-w-xl leading-relaxed">
              Precision athletic wear built for those who refuse to compromise. 
              Track-tested. Street-ready. Zero excuses.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button asChild variant="outline" size="lg" className="rounded-none font-mono uppercase tracking-wider h-14 border-border hover:bg-secondary transition-colors">
                <Link href="/about">Access Intel</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-border">
            <div className="p-6 md:p-8 flex flex-col items-center justify-center text-center gap-2">
              ...
              <span className="font-mono text-xs text-muted-foreground uppercase tracking-wider">Active Units</span>
            </div>
            <div className="p-6 md:p-8 flex flex-col items-center justify-center text-center gap-2">
              ...
              <span className="font-mono text-xs text-muted-foreground uppercase tracking-wider">Divisions</span>
            </div>
            <div className="p-6 md:p-8 flex flex-col items-center justify-center text-center gap-2">
              ...
              <span className="font-mono text-xs text-muted-foreground uppercase tracking-wider">Elite Items</span>
            </div>
            <div className="p-6 md:p-8 flex flex-col items-center justify-center text-center gap-2">
              <Globe className="w-6 h-6 text-primary mb-2 opacity-50" />
              <span className="font-display text-3xl md:text-4xl font-bold">Global</span>
              <span className="font-mono text-xs text-muted-foreground uppercase tracking-wider">Shipping</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background relative">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <h2 className="font-mono text-primary text-sm uppercase tracking-widest mb-2">// Featured Deployment</h2>
              <h3 className="font-display text-4xl md:text-5xl font-bold uppercase tracking-tight">Elite Series</h3>
            </div>
            <Button asChild variant="ghost" className="rounded-none font-mono uppercase tracking-wider hover:bg-secondary group">
              <Link href="/products">
                View All Ops <ChevronRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
          </div>
      ...
      <section className="py-24 bg-card border-t border-border">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="font-mono text-primary text-sm uppercase tracking-widest mb-2 text-center">// Divisions</h2>
          <h3 className="font-display text-4xl md:text-5xl font-bold uppercase tracking-tight text-center mb-16">Select Protocol</h3>
                ...
                >
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-end">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="font-mono text-xs text-primary mb-2 block uppercase tracking-widest">0{index + 1} / {category.productCount} Items</span>
      ...
      <section className="py-32 relative overflow-hidden bg-background border-t border-border flex items-center justify-center text-center">
        ...
        <div className="container relative z-10 px-4 max-w-4xl mx-auto space-y-8">
          ...
          <p className="font-mono text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto">
            Unlock exclusive drops, early access to prototype gear, and classified intel.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-8">
            <Button asChild size="lg" className="rounded-none font-display font-bold uppercase tracking-wider text-lg h-14 bg-primary text-primary-foreground hover:bg-primary/90">
              <Link href="/contact">Establish Comms</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="rounded-none font-mono uppercase tracking-wider h-14 border-border hover:bg-secondary">
              <Link href="/social">Access Network Links</Link>
            </Button>
          </div>
        </div>
      </section>
