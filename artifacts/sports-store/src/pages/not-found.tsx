  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-background px-4">
      <div className="text-center max-w-lg w-full border border-border bg-card p-12 relative overflow-hidden">
        ...
        <h2 className="font-display text-2xl uppercase font-bold mb-4 tracking-tight">Signal Lost</h2>
        
        <p className="font-mono text-muted-foreground mb-8 text-sm leading-relaxed">
          The requested sector is offline or does not exist. Verify coordinates and attempt realignment.
        </p>
