...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:Arial,sans-serif;color:#e0e0e0;">
  <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    ...
    <table style="width:100%;border-collapse:collapse;margin-bottom:24px;background:#141414;border:1px solid #2a2a2a;">
      ...
      ${order.customerStreet ? `<tr><td style="padding:12px;color:#888;border-bottom:1px solid #2a2a2a;">כתובת למשלוח</td><td style="padding:12px;font-weight:bold;border-bottom:1px solid #2a2a2a;">${order.customerStreet} ${order.customerHouseNumber ?? ""}, ${order.customerCity ?? ""}${order.customerZipCode ? ` — מיקוד ${order.customerZipCode}` : ""}</td></tr>` : ""}
